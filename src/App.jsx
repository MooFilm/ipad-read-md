...
3. กด **ซิงก์ GitHub** เพื่อดึงไฟล์ล่าสุดเข้าชั้นหนังสือ
          ...
          <div className="modal-card help-card" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="help-list">
              ...
              <article>
                ...
                <p>ถ้า repo เป็น public ให้ใส่ค่าใน readshelf.config.json แล้วกด “ซิงก์ GitHub” เพื่อดึงไฟล์จาก {githubRootPath}</p>
              </article>
              <article>
